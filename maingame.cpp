    ...
    void print_board(){
        ...
        for(int j=0;j<sizeY;j++){
            ...
            for (int i=0; i<sizeX;i++){
                ...
                if (numAdjacentMines(i,j) == 1) { //SEGMENTATION ERROR: seems to be caused by numAdjacentMines(i,j)
                    cout << setw(2) << "\033[;34m1\033[0m\n";
                }
                else if (numAdjacentMines(i,j) == 2) {
                    cout << setw(2) << "\033[;32m2\033[0m\n";
                }
                else if (numAdjacentMines(i,j) == 3) {
                    cout << setw(2) << "\033[;31m3\033[0m\n";
                }
                else {
